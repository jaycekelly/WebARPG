...
export const ICON_PATHS: Record<string, IconPathDef | PathItem[]> = {
  ...
  // ---- Fighter Kit Test Enemies (mapped to the closest-fitting animal icon) ----
  ironclad_brute: [ // Heavy armored melee -> Turtle (shell, slow, tanky)
    'm12 10 2 4v3a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-3a8 8 0 1 0-16 0v3a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-3l2-4h4Z',
    'M4.82 7.9 8 10',
    'M15.18 7.9 12 10',
    'M16.93 10H20a2 2 0 0 1 0 4H2',
  ],
  cultist_arbalest: [ // Ranged skirmisher -> Bird (flighty, keeps distance)
    'M16 7h.01',
    'M3.4 18H12a8 8 0 0 0 8-8V7a4 4 0 0 0-7.28-2.3L2 20',
    'm20 7 2 .5-2 .5',
    'M10 18v3',
  ...
  footman: [ // Standard fast melee grunt -> Rabbit (nimble, basic)
    'M13 16a3 3 0 0 1 2.24 5',
    'M18 12h.01',
    'M18 21h-8a4 4 0 0 1-4-4 7 7 0 0 1 7-7h.2L9.6 6.4a1 1 0 1 1 2.8-2.8L15.8 7h.2c3.3 0 6 2.7 6 6v1a2 2 0 0 1-2 2h-1a3 3 0 0 0-3 3',
    'M20 8.54V4a2 2 0 1 0-4 0v3',
  ...
  Hammer: [
    'M15 12 3.5 23.5a1.5 1.5 0 0 1-2-2L12 10',
    'M15 4l6 6-3 3-6-6z',
    'M17 2l5 5-2 2-5-5z',
  ],
  Mountain: [
  ...
  Rocket: [
    'M9 15l-3 3 0 3 3 0 3-3',
    'M12 15c2-1 4-3 6-6 3-4.5 3-8 3-8s-3.5 0-8 3c-3 2-5 4-6 6',
    'M9 15c-1.5-1.5-2-3-2-3s1.5.5 3 2',
  ...
  Sparkles: [
    ...
    'M19 15l.7 2.1 2.1.7-2.1.7-.7 2.1-.7-2.1-2.1-.7 2.1-.7Z',
    'M5 16l.5 1.5L7 18l-1.5.5L5 20l-.5-1.5L3 18l1.5-.5Z',
  ],
  Shield: [
