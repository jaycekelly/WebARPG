...
export function ItemTooltip({ item }: Props) {
  ...
  return (
    <div className="w-60 bg-[#0e0f11] shadow-[0_15px_50px_-10px_rgba(0,0,0,0.85)] rounded-none px-2 py-1.5 text-left pointer-events-none">
      ...
      <div className="flex justify-between items-center text-[0.625rem] text-text-secondary border-b border-[#202227]/40 pb-1 mb-1 uppercase tracking-widest">
      ...
      {item.affixes.length > 0 && (
        <div className="space-y-0.5 mt-1 pt-1 border-t border-[#202227]/40">
      ...
      {item.requirements && (
        <div className="mt-1 pt-1 border-t border-[#202227]/40 space-y-0.5">
